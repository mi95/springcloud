...
//            if (e2.getErrorCode() == CommonValues.PK_UK_ERROR_CODE) {
...
//        }
    ...
    private String getErrorsMsg(Integer code) throws CommonException {
        if (code == null || code < 1000) {
            CommonException.throwNewCommonExceptionForCustom("");
        }
        //获取指定类所有属性上的注解
        ...
        CommonException.throwNewCommonExceptionForCustom("系统处理异常");
        return null;
    }
}